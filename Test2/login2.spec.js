...
describe("Login Tests", function () {
    ...
    it("Test unsuccessful login", async function () {
        ...
        //console.log("This is the usernameFieldClass: " + usernameFieldClass);
        //console.log("This is the passwordFieldClass: " + passwordFieldClass);
        //console.log("This is the errorMessageElementText: " + errorMessageElementText);
